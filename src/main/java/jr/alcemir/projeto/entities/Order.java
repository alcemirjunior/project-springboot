...
public class Order implements Serializable {
    ...
    private Integer orderStatus; //so é inteiro dentro da classe
    ...
    @OneToOne(mappedBy = "order", cascade = CascadeType.ALL) //mapeia para o pedido e o pagamento terem o mesmo ID
